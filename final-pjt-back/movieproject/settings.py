...
SECRET_KEY = 'django-insecure-5n-=7v8stsn5$@8$t@zb73zkr#5rf+4h26oyhwf$-)k=dv_%r7'
...
INSTALLED_APPS = [
    ...
    # signup 담당을 위해 필요한 Apps
    'allauth', #main 담당
    'allauth.account', # 소셜 로그인한 사람들 관리
    'allauth.socialaccount', # 소셜
    #provider 구글 페이스북 카톡 깃허브 등 소셜로그인 제공업체
    'allauth.socialaccount.providers.naver',
    'allauth.socialaccount.providers.google',

    # django apps
    'django.contrib.sites',  # 사이트 관련 정보 관리
